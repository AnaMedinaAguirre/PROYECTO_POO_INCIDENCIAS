...
public class Incidencia {
    ...
    public int getAsignadox() {
        return asignadox;
    }

    public void setAsignadox(int asignadox) {
        this.asignadox = asignadox;
    }
    ...
    public String getNombreAsignadoX() {
        return nombreAsignadoX;
    }

    public void setNombreAsignadoX(String nombreAsignadoX) {
        this.nombreAsignadoX = nombreAsignadoX;
    }

    public String getNombreAsignadoA() {
        return nombreAsignadoA;
    }
